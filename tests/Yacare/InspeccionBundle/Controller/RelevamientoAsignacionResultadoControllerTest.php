...
/*
 * Prueba de RelevamientoAsignacionResultadoController.
 * 
...
class RelevamientoAsignacionResultadoControllerTest extends \Tapir\BaseBundle\Controller\AbmControllerTest
{
	...
	public function testBaseRoute()
	{
		...
		$this->assertEquals('yacare_inspeccion_relevamientoasignacionresultado_listar', $this->item->obtenerRutaBase('listar'));
	}
}