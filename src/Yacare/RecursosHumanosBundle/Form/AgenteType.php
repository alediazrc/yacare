...
class AgenteType extends AbstractType
{
    ...
    {
        $builder->add('id', null, 
            array('label' => 'Legajo','read_only' => true))
            ->add('Grupos', 'entity', 
            array(
                'label' => 'Grupos',
            ...
            ->add('Persona', new \Yacare\RecursosHumanosBundle\Form\PersonaAgenteType(), 
            array('label' => 'Persona'));
    }
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(
            array('data_class' => 'Yacare\RecursosHumanosBundle\Entity\Agente'));
    }
