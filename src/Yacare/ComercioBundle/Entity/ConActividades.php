...
trait ConActividades
{
    ...
    public function getRequiereInfEscolar()
    {
        ...
        return ($Activ1 != null && $Activ1->getRequiereInfEscolar()) || ($Activ2 != null && $Activ2->getRequiereInfEscolar()) ||
             ($Activ3 != null && $Activ3->getRequiereInfEscolar())|| ($Activ4 != null && $Activ4->getRequiereInfEscolar()
             || ($Activ5 != null && $Activ5->getRequiereInfEscolar())|| ($Activ6 != null && $Activ6->getRequiereInfEscolar()));
    }
    ...
    public function getRequiereCamaraBarro()
    {
        ...
        return ($Activ1 != null && $Activ1->getRequiereCamaraBarro()) || ($Activ2 != null && $Activ2->getRequiereCamaraBarro()) ||
             ($Activ3 != null && $Activ3->getRequiereCamaraBarro())|| ($Activ4 != null && $Activ4->getRequiereCamaraBarro()
             || ($Activ5 != null && $Activ5->getRequiereCamaraBarro())|| ($Activ6 != null && $Activ6->getRequiereCamaraBarro()));
    }
