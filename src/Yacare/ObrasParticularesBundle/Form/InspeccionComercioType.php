...
class InspeccionComercioType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('Partida', 'entity_id', 
            ...
            ->add('Actividades', new \Yacare\ComercioBundle\Form\Type\ActividadesType(), 
            array('label' => 'Actividades ClaMAE 2014'))
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(
            array('data_class' => 'Yacare\ObrasParticularesBundle\Entity\InspeccionComercio'));
    }
