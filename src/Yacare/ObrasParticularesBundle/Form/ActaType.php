...
class ActaType extends AbstractType
{
    ...
    {
        $builder->add('Talonario', null, array('label' => 'Talonario'))
            ...
            array(
                ...
                'widget' => 'single_text',
                'label' => 'Fecha'))
            ->add('Comercio', 'entity_id', 
            array('label' => 'Comercio','class' => 'Yacare\ComercioBundle\Entity\Comercio','required' => false))
            ->add('Persona', 'entity_id', 
            array(
                'label' => 'Persona',
            ...
            ->add('FuncionarioPrincipal', 'entity_id', 
            array(
                'label' => 'Funcionario Principal',
                'class' => 'Yacare\BaseBundle\Entity\Persona',
                'filters' => array('filtro_grupo' => 1),
                'required' => true))
            ->add('FuncionarioSecundario', 'entity_id', 
            array(
