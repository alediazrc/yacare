...
class PartidaController extends Controller
{
    ...
    public function listarAction()
    {
        ...
        $entities = $em->getRepository('YacareCatastroBundle:Partida')->findAll();
    ...
    public function editarAction($id = null)
    {
        ...
        if($id)
            $entity = $em->getRepository('YacareCatastroBundle:Partida')->find($id);
        else
            $entity = new Partida();
        ...
        $editForm = $this->createForm(new PartidaType(), $entity);
     ...
     * @Route("guardar")
     * @Method("POST")
     * @Template("YacareCatastroBundle:Partida:edit.html.twig")
     */
