...
interface NodeInterface
{
    ...
    /**
     * @return string the materialized path, eg the representation of path from all ancestors
     */
    public function getMaterializedPath();

    /**
     * @return string the real materialized path, eg the representation of path from all ancestors + current node       
     */
